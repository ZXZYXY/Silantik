    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Konfigurasi Web</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <div class="col-lg-12">
                            ...
                            <div class="card-body">
                                <form action="{{ url('setting/konfigurasi/submit') }}" method="POST">
                                    ...
                                    <x-forms.input_v id="keterangan_aplikasi" type="text" name="keterangan_aplikasi"
                                        label="Keterangan Aplikasi" isRequired="false"
                                        value="{{ $conf->keterangan_aplikasi }}" isReadonly="" placeholder="" />
                        ...
                        <div class="card card-{{ konfigurasi()->navbar_color }} card-outline">
                            ...
                            <div class="card-body">
                                ...
                                <x-forms.textarea_v name="meta_keyword" id="meta_keyword" label="Meta Keyword"
                                    isRequired="" value="{{ $conf->meta_keyword }}" />
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="card card-{{ konfigurasi()->navbar_color }} card-outline">
                            ...
                            <div class="card-body">
                                <x-forms.input_v id="email" type="email" name="email" label="Email"
                                    isRequired="false" value="{{ $conf->email }}" isReadonly="" placeholder="" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <form action="{{ url('setting/konfigurasi/favicon') }}" method="POST"
                                            ...
                                            <input type="hidden" name="id" value="{{ $conf->id }}">
                                            <div
                                                class="form-group mb-3 {{ $errors->has('favicon') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-3">
                                        <form action="{{ url('setting/konfigurasi/logo_kecil') }}" method="POST"
                                            ...
                                            <input type="hidden" name="id" value="{{ $conf->id }}">
                                            <div
                                                class="form-group mb-3 {{ $errors->has('logo_kecil') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-3">
                                        <form action="{{ url('setting/konfigurasi/gambar_sidebar') }}" method="POST"
                                            ...
                                            <div
                                                ...
                                                <p align="center"><img src="{{ $conf->getGambarSidebar() }}"
                                                        width="250px">
                                                </p>
                                                ...
                                                @if ($errors->has('gambar_sidebar'))
                                                    <span
                                                        class="text-danger">{{ $errors->first('gambar_sidebar') }}</span>
                                                @endif
                                            </div>
                                            <button type="submit" class="btn btn-primary btn-block"><i
                                                    class="fa fa-save"></i>
