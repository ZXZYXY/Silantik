                                        ...
                                        <div class="card-body p-md-5">
                                            ...
                                            <div class="">
                                                <div class="form-body">
                                                    ...
                                                    <p>Masukan NIP (Nomor Induk Pegawai) PIC Pemohon Jaringan Infrastruktur</p>
                                                    @if ($errors->any())
                                                    ...
                                                    @endif
                                                    <form action="{{ url('/jaringan_form/cek-nip') }}" method="get" class="">
                                                        <div class="col-12">
                                                            <input type="text" name="nip" class="form-control" placeholder="NIP (Nomor Induk Pegawai)">
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="d-grid">
                                                                <button type="submit" class="btn btn-primary mt-2"><i class="fa fa-arrow-right me-1"></i>Lanjut</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
