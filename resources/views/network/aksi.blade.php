<div class="btn-group">
    ...
    <div class="dropdown-menu">
        ...
        <a href="{{ route('network.show', $data->uuid) }}" class="dropdown-item" title="Detail"><i class="fa fa-eye"></i> Detail</a>
        ...
        @if (auth()->user()->can('network-delete'))
            <button class="dropdown-item hapus" network-name="{{ $data->alamat }}" network-id="{{ $data->uuid }}"
