...
@section('content')
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="mb-0">Tambah Permohonan Pembuatan Aplikasi</h4>
                    <hr>
                    @if (count($errors) > 0)
                    ...
                    <form action="{{ url('permohonan/store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <input type="hidden" name="jenis_permohonan" value="pembuatan">
                                ...
                                <x-forms.textarea_v id="deskripsi" type="text" name="deskripsi"
                                    label="Deskripsi Aplikasi" isRequired="true" value="" isReadonly=""
